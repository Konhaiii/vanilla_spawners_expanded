...
public class CalibratedSpawnerBlockEntity extends BlockEntity {
	...
	public static void clientTick(World world, BlockPos pos, BlockState ignoreState, CalibratedSpawnerBlockEntity blockEntity) {
		blockEntity.logic.clientTick(world, pos);
	}

	public static void serverTick(World world, BlockPos pos, BlockState ignoreState, CalibratedSpawnerBlockEntity blockEntity) {
